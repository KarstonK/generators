...
public class MCreatorGoldGeneratorSpawn extends Elementsgenerators.ModElement {
	public MCreatorGoldGeneratorSpawn(Elementsgenerators instance) {
		super(instance, 24);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure MCreatorGoldGeneratorSpawn!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure MCreatorGoldGeneratorSpawn!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure MCreatorGoldGeneratorSpawn!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure MCreatorGoldGeneratorSpawn!");
			return;
		}
				...
				if (!world.isRemote && world.getServer() != null) {
					world.getServer()
							...
							.handleCommand(
									...
									"summon minecraft:item ~ ~ ~ {Item:{id:\"minecraft:gold_ingot\",Count:1b}}");
				}
			} else {
				{
					TileEntity tileEntity = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
				...
				if (!world.isRemote && world.getServer() != null) {
					world.getServer()
							...
							.handleCommand(
									new CommandSource(ICommandSource.field_213139_a_, new Vec3d((x + 0.5), (y + 1), (z + 0.5)), Vec2f.ZERO,
											(ServerWorld) world, 4, "", new StringTextComponent(""), world.getServer(), null).withFeedbackDisabled(),
									"summon minecraft:item ~ ~ ~ {Item:{id:\"minecraft:gold_ingot\",Count:4b}}");
				}
			} else {
				{
					TileEntity tileEntity = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
