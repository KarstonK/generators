...
public class MCreatorIronGeneratorGUI4 extends Elementsgenerators.ModElement {
	public static HashMap guiinventory = new HashMap();
	public static IInventory inherited;
	private static ContainerType<GuiContainerMod> containerType = null;

	public MCreatorIronGeneratorGUI4(Elementsgenerators instance) {
		super(instance, 9);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("irongeneratorgui4"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("generators:textures/irongeneratorgui4.png");
