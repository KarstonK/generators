...
public class MCreatorIronGeneratorGUI3 extends Elementsgenerators.ModElement {
	public static HashMap guiinventory = new HashMap();
	public static IInventory inherited;
	private static ContainerType<GuiContainerMod> containerType = null;

	public MCreatorIronGeneratorGUI3(Elementsgenerators instance) {
		super(instance, 8);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("irongeneratorgui3"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("generators:textures/irongeneratorgui3.png");
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Level:3         Required:32", 7, 6, -10066330);
			this.font.drawString("Spawn rate: 3s", 7, 18, -10066330);
			this.font.drawString("Spawn amount:1", 7, 29, -10066330);
			this.font.drawString("Next:Amount to 2", 7, 41, -10066330);
		}
