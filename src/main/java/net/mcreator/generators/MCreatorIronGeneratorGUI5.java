...
public class MCreatorIronGeneratorGUI5 extends Elementsgenerators.ModElement {
	public static HashMap guiinventory = new HashMap();
	public static IInventory inherited;
	private static ContainerType<GuiContainerMod> containerType = null;

	public MCreatorIronGeneratorGUI5(Elementsgenerators instance) {
		super(instance, 10);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("irongeneratorgui5"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("generators:textures/irongeneratorgui5.png");
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Level:5         Required:128", 7, 6, -10066330);
			this.font.drawString("Spawn rate: 2s", 7, 18, -10066330);
			this.font.drawString("Spawn amount:2", 7, 29, -10066330);
			this.font.drawString("Next:Amount to 4", 7, 40, -10066330);
		}
