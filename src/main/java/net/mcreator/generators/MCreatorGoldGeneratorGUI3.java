...
public class MCreatorGoldGeneratorGUI3 extends Elementsgenerators.ModElement {
	public static HashMap guiinventory = new HashMap();
	public static IInventory inherited;
	private static ContainerType<GuiContainerMod> containerType = null;

	public MCreatorGoldGeneratorGUI3(Elementsgenerators instance) {
		super(instance, 15);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("goldgeneratorgui3"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("generators:textures/goldgeneratorgui3.png");
