...
public class MCreatorGoldGeneratorGUI5 extends Elementsgenerators.ModElement {
	public static HashMap guiinventory = new HashMap();
	public static IInventory inherited;
	private static ContainerType<GuiContainerMod> containerType = null;

	public MCreatorGoldGeneratorGUI5(Elementsgenerators instance) {
		super(instance, 17);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("goldgeneratorgui5"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("generators:textures/goldgeneratorgui5.png");
